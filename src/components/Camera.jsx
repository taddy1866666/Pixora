  ...
  return (
    ...
    {showPhotosModal && (
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-end md:items-center justify-center z-50 p-0 md:p-4 animate-fade-in">
        ...
        <div className="bg-white rounded-t-3xl md:rounded-3xl w-full md:max-w-2xl md:max-h-[85vh] h-screen md:h-auto flex flex-col animate-scale-in shadow-2xl shadow-black/30 overflow-hidden relative">
          
          {/* Header - Fixed at top */}
          <div className="flex justify-between items-center px-4 xs:px-6 py-4 border-b border-rose-100/50 bg-gradient-to-r from-white to-rose-50/30 flex-shrink-0">
            <h3 className="text-xl xs:text-2xl font-bold bg-gradient-to-r from-indigo-900 to-rose-900 bg-clip-text text-transparent">
              Captured Photos
            </h3>
            <button
              onClick={() => setShowPhotosModal(false)}
              className="w-10 h-10 rounded-full bg-rose-100 hover:bg-rose-200 transition-colors flex items-center justify-center cursor-pointer"
          ...
          <div className="flex-1 overflow-y-auto px-4 xs:px-6 py-6 min-h-0">
            <div className={`grid ${
              extraShots === 1 ? 'grid-cols-1 justify-items-center' : 
              ...
              {Array.from({ length: extraShots }).map((_, index) => (
                <div
                  key={index}
                  className="relative aspect-square rounded-xl overflow-hidden border-3 border-rose-200 bg-gray-100 shadow-md hover:shadow-lg transition-shadow"
                >
          ...
          {capturedImages.length === extraShots && (
            <>
              ...
              <button
                ...
                className="md:hidden absolute top-4 right-4 px-6 py-3 bg-gradient-to-r from-rose-500 to-rose-600 text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all active:scale-95 cursor-pointer flex items-center gap-2 z-20"
              >
                Continue
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="hidden md:flex border-t border-rose-100/50 bg-gradient-to-r from-rose-50/50 to-indigo-50/50 px-6 py-4 gap-3 flex-shrink-0">
                <button
                  onClick={handleRetake}
                  className="flex-1 px-4 py-3 bg-white border-2 border-rose-300 text-rose-700 font-bold rounded-xl hover:bg-rose-50 hover:border-rose-400 transition-all active:scale-95 cursor-pointer min-h-12 flex items-center justify-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                  </svg>
                ...
                <button
                  onClick={handleContinue}
                  className="flex-1 px-4 py-3 bg-gradient-to-r from-rose-500 to-rose-600 text-white font-bold rounded-xl hover:from-rose-600 hover:to-rose-700 transition-all active:scale-95 cursor-pointer min-h-12 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                >
                  Continue
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6" />
