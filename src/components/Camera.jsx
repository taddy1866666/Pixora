  ...
  return (
    ...
    {showPhotosModal && (
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-3 xs:p-4 animate-fade-in">
        <div className="bg-gradient-to-br from-white to-indigo-50/30 rounded-3xl max-w-4xl w-full max-h-[90vh] flex flex-col animate-scale-in shadow-2xl shadow-black/30 border border-white/50">
          {/* Header - Fixed */}
          <div className="flex justify-between items-center px-3 xs:px-4 md:px-6 pt-3 xs:pt-4 md:pt-6 pb-3 xs:pb-4 border-b border-indigo-100 flex-shrink-0">
          ...
          {/* Images - Scrollable */}
          <div className="overflow-y-auto flex-1 px-3 xs:px-4 md:px-6 py-4 xs:py-5 md:py-6">
            <div className={`grid ${extraShots === 1 ? 'grid-cols-1 max-w-xs xs:max-w-md mx-auto' : extraShots === 2 ? 'grid-cols-2 gap-2 xs:gap-3 md:gap-4' : extraShots === 3 ? 'grid-cols-2 xs:grid-cols-3 gap-2 xs:gap-3 md:gap-4' : 'grid-cols-2 gap-2 xs:gap-3 md:gap-4'}`}>
          ...
          {capturedImages.length === extraShots && (
            <div className="flex flex-col xs:flex-row gap-2 xs:gap-3 justify-center border-t border-indigo-100 px-3 xs:px-4 md:px-6 py-3 xs:py-4 md:py-5 bg-gradient-to-r from-rose-50/50 to-indigo-50/50 flex-shrink-0">
              <button
                onClick={handleRetake}
                className="px-3 xs:px-6 py-2 xs:py-3 bg-white border-2 border-rose-300 text-rose-700 rounded-lg xs:rounded-xl font-bold text-xs xs:text-sm md:text-base hover:bg-rose-50 hover:border-rose-400 hover:scale-105 hover:shadow-lg active:scale-95 transition-all flex items-center justify-center gap-1 xs:gap-2 shadow-sm flex-1 xs:flex-none min-h-10 xs:min-h-11"
              >
              ...
              <button
                ...
                className="px-4 xs:px-8 py-2 xs:py-3 bg-gradient-to-r from-rose-500 to-rose-600 text-white rounded-lg xs:rounded-xl font-bold text-xs xs:text-sm md:text-base md:text-lg hover:from-rose-600 hover:to-rose-700 hover:scale-105 hover:shadow-lg hover:shadow-rose-500/50 active:scale-95 transition-all flex items-center justify-center gap-1 xs:gap-2 shadow-lg flex-1 min-h-10 xs:min-h-11"
              >
                Continue
                <svg className="w-4 xs:w-5 h-4 xs:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
